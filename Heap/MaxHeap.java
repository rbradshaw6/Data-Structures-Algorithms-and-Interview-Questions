...
public class MaxHeap<T extends Comparable<? super T>> {
    ...
    /**
     * Adds multiple elements to max heap in order. Mostly for expedited testing but it has some utility I guess.
     * @param data
     */
    public void add(T... data) {
        if (data == null) {
    ...
    private void heapify(int i) {
        ...
        if (this.size > right && this.arr[right].compareTo(arr[curr]) > 0) {
    ...
    public static void main(String[] args) {
        ...
        minHeap.add(1, 6, 100, 4, 15, 0, 12, 11, 9, 200, 99, 2, 1);
